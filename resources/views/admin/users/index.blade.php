            ...
            <div class="page-header">
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{URL::current()}}">users</a></li>
                    </ol>
                </nav>
            </div>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuReference25">
                                                            ...
                                                            <a class="dropdown-item btn btn-sm" href="{{route('admin.user.edit',[$user])}}">Edit</a>
                                                            <div class="dropdown-divider"></div>
                                                            <form method="post" action="{{route('admin.user.destroy',[$user])}}">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button data-name="order" class="btn btn-danger dropdown-item mb-3" type="submit">Delete</button>
                                                            </form>
