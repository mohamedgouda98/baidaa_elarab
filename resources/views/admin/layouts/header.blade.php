...
<div class="header-container">
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <a class="navbar-brand" href="{{ route('admin.dashboard') }}"><img alt="logo" src="{{ \Illuminate\Support\Facades\URL::asset('assetsAdmin/assets/img/90x90.jpg') }}"> <span class="navbar-brand-name">CORK</span></a>
        </div>
        ...
        <ul class="navbar-item flex-row nav-dropdowns">
            <li class="nav-item dropdown language-dropdown more-dropdown">
                <div class="dropdown custom-dropdown-icon">
                    <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ \Illuminate\Support\Facades\URL::asset('assetsAdmin/assets/img/ca.png') }}" class="flag-width" alt="flag"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg></a>

                    <div class="dropdown-menu dropdown-menu-right animated fadeInUp" aria-labelledby="customDropdown">
                        <a class="dropdown-item" data-img-value="de" data-value="de" href="javascript:void(0);"><img src="{{ \Illuminate\Support\Facades\URL::asset('assetsAdmin/assets/img/de.png') }}" class="flag-width" alt="flag"> German</a>
                        <a class="dropdown-item" data-img-value="jp" data-value="jp" href="javascript:void(0);"><img src="{{ \Illuminate\Support\Facades\URL::asset('assetsAdmin/assets/img/jp.png') }}" class="flag-width" alt="flag"> Japanese</a>
                        <a class="dropdown-item" data-img-value="fr" data-value="fr" href="javascript:void(0);"><img src="{{ \Illuminate\Support\Facades\URL::asset('assetsAdmin/assets/img/fr.png') }}" class="flag-width" alt="flag"> French</a>
                        <a class="dropdown-item" data-img-value="ca" data-value="en" href="javascript:void(0);"><img src="{{ \Illuminate\Support\Facades\URL::asset('assetsAdmin/assets/img/ca.png') }}" class="flag-width" alt="flag"> English</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="media">
                        <img src="{{ \Illuminate\Support\Facades\URL::asset('assetsAdmin/assets/img/90x90.jpg') }}" class="img-fluid" alt="admin-profile">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="{{ route('admin.dashboard') }}">
                    <img src="{{ \Illuminate\Support\Facades\URL::asset('assetsAdmin/assets/img/90x90.jpg') }}" class="navbar-logo" alt="logo">
                </a>
            </li>
        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            <li class="menu single-menu">
                ...
                <ul class="collapse submenu list-unstyled" id="app" data-parent="#topAccordion">
                    <li>
                        <a href="{{ route('admin.country.index') }}"> Show Countries </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.country.create') }}"> Add New Country </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu single-menu">
                ...
                <ul class="collapse submenu list-unstyled" id="components" data-parent="#topAccordion">
                    <li>
                        <a href="{{ route('admin.poet.index') }}"> Poet </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.poet.create') }}"> Add New Poet </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu single-menu">
                ...
                <ul class="collapse submenu list-unstyled" id="tables"  data-parent="#topAccordion">
                            ...
                            <li>
                                <a href="{{route('admin.poeticType.create')}}"> Add PoeticTyes </a>
                            </li>
