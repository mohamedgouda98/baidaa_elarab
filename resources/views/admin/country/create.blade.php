                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{URL::current()}}">Add New Country</a></li>
                        </ol>
                    </nav>
                            ...
                            <form action="{{route('admin.country.store')}}" method="post">
                                ...
                                <div id="fuMultipleFile" class="col-lg-12 layout-spacing">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="old_name" class="form-control @error('old_name') is-invalid fparsley-error parsley-error @enderror" placeholder="Enter Old Name " value="{{old('old_name')}}">
                                        @error('old_name')
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="current_name" class="form-control @error('current_name') is-invalid fparsley-error parsley-error @enderror" placeholder="Enter Current Name " value="{{old('current_name')}}">
                                        @error('current_name')
                                        <span class="invalid-feedback text-danger" role="alert">
                                              <p>{{ $message }}</p>
                                            </span>
