                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{URL::current()}}">Countries</a></li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="seperator-header text-right">
                            <a href="{{route('admin.country.create')}}"><h4 class="">Add New Country</h4></a>
                        </div>
                                        ...
                                        <table id="style-1" class="table style-1 dt-table-hover non-hover">
                                            ...
                                            @isset($countries)
                                                @foreach($countries as $country)
                                                    <tr>
                                                        <td class="checkbox-column"> {{$country->id}} </td>
                                                        <td> {{$country->id}} </td>
                                                        <td class="user-name">{{$country->old_name}}</td>
                                                        <td class="user-name">{{$country->current_name}}</td>
                                                        <td class="text-center">
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuReference25">
                                                                    ...
                                                                    <form method="post" action="{{ route('admin.country.destroy', $country) }}">
                                                                        @csrf
                                                                        @method('DELETE')
