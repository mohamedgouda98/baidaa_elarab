                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{URL::current()}}">Update Poem</a></li>
                        </ol>
                    </nav>
                ...
                <div class="container">
                    <div class="row my-5 mx-auto">
                        <div class="col-lg-12 layout-spacing">
                            <form action="{{route('admin.poem.update', $poem)}}" method="post">
                                @csrf
                                @method('PUT')
                                <div id="fuMultipleFile" class="col-lg-12 layout-spacing">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="title" class="form-control @error('title') is-invalid fparsley-error parsley-error @enderror" placeholder="Enter Your Title " value="{{old('title', $poem->title)}}" required>
                                        @error('title')
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="body" class="form-control @error('body') is-invalid fparsley-error parsley-error @enderror" placeholder="Enter Body " required>{{old('body', $poem->body)}}</textarea>
                                        @error('body')
                                        <span class="invalid-feedback text-danger" role="alert">
                                              <p>{{ $message }}</p>
                                            </span>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="description" class=" @error('description') is-invalid fparsley-error parsley-error @enderror" id="editor">{{ old('description', $poem->decription) }}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback text-danger" role="alert">
                                           <p>{{ $message }}</p>
                                        </span>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="verses_count" class="form-control @error('verses_count') is-invalid fparsley-error parsley-error @enderror" placeholder="Enter Your Verses Count " value="{{old('verses_count', $poem->verses_count)}}" required>
                                        @error('verses_count')
                                        <span class="invalid-feedback text-danger" role="alert">
                                              <p>{{ $message }}</p>
                                            </span>
                                        ...
                                        <select name="poet" class="form-control @error('poet') is-invalid fparsley-error parsley-error @enderror" required>
                                            ...
                                            @isset($poets)
                                                @foreach($poets as $poet)
                                                    <option value="{{ $poet->id }}" {{ ($poet->id == $poem->poet_id) ? 'selected' : '' }}>{{ $poet->name }}</option>
                                                @endforeach
                                            @endisset
                                        </select>
                                        @error('poet')
                                        ...
                                        <select name="poetic_type" class="form-control @error('poetic_type') is-invalid fparsley-error parsley-error @enderror" required>
                                            ...
                                            @isset($poeticTypes)
                                                @foreach($poeticTypes as $item)
                                                    <option value="{{ $item->id }}" {{ ($item->id == $poem->poetic_type_id) ? 'selected' : '' }}>{{ $item->name }}</option>
                                                @endforeach
                                            @endisset
                                        </select>
                                        @error('poetic_type')
