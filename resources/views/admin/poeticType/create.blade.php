                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.poeticType.index')}}">PoeticTypes</a></li>&nbsp;
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{URL::current()}}">Add New PoeticType</a></li>
                        </ol>
                    </nav>
                            ...
                            <form action="{{route('admin.poeticType.store')}}" method="post">
                                ...
                                <div id="fuMultipleFile" class="col-lg-12 layout-spacing">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="name" class="form-control @error('name') is-invalid fparsley-error parsley-error @enderror" placeholder="Enter PoeticType Name " value="{{old('name')}}">
                                        @error('name')
