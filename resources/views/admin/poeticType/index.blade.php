                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{URL::current()}}">PoeticTypes</a></li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="seperator-header">
                            <h4 class="">PoeticTypes</h4>
                        </div>
                        <div class="seperator-header text-right">
                            <a href="{{route('admin.poeticType.create')}}"><h4 class="">Add New PoeticType</h4></a>
                        </div>
                                ...
                                <div class="statbox widget box box-shadow">
                                    <div class="widget-content widget-content-area">
                                        <table id="style-1" class="table style-1 dt-table-hover non-hover">
                                            ...
                                            <tbody>
                                            @isset($poeticTypes)
                                                @foreach($poeticTypes as $poeticType)                    
                                                    <tr>
                                                        <td class="checkbox-column"> {{$poeticType->id}} </td>
                                                        <td> {{$poeticType->id}} </td>
                                                        <td class="user-name">{{$poeticType->name}}</td>
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuReference25">
                                                                    ...
                                                                    <a class="dropdown-item btn btn-sm"
                                                                       href="{{route('admin.poeticType.edit',[$poeticType])}}">Edit</a>
                                                                    <div class="dropdown-divider"></div>
                                                                    <form method="post" action="{{route('admin.poeticType.destroy',[$poeticType])}}">
                                                                        @csrf
                                                                        @method('DELETE')
