...
@endsection
@section('bodyClass') alt-menu sidebar-noneoverflow @endsection
@section('content')
    <!--  BEGIN CONTENT PART  -->
        ...
        <div class="layout-px-spacing">
            <div class="page-header">
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ URL::current() }}">Dashboard</a></li>
                    </ol>
                </nav>
            </div>
...
@section('js')
    <script src="{{ URL::asset('assetsAdmin/plugins/apex/apexcharts.min.js') }}"></script>
    <script src="{{ URL::asset('assetsAdmin/assets/js/dashboard/dash_2.js') }}"></script>
@endsection
