                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{URL::current()}}">eras</a></li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="seperator-header text-right">
                            <a href="{{route('admin.era.create')}}"><h4 class="">Add New era</h4></a>
                        </div>
                                    ...
                                    <div class="widget-content widget-content-area">
                                        <table id="style-1" class="table style-1 dt-table-hover non-hover">
                                            ...
                                            @isset($eras)
                                                @foreach($eras as $era)                    
                                                    <tr>
                                                        <td class="checkbox-column"> {{$era->id}} </td>
                                                        <td> {{$era->id}} </td>
                                                        <td class="user-name">{{$era->name}}</td>
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuReference25">
                                                                    ...
                                                                    <a class="dropdown-item btn btn-sm"
                                                                       href="{{route('admin.era.edit',[$era])}}">Edit</a>
                                                                    <div class="dropdown-divider"></div>
                                                                    <form method="post" action="{{route('admin.era.destroy',[$era])}}">
                                                                        @csrf
                                                                        @method('DELETE')
